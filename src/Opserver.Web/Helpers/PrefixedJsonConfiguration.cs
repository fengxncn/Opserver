...
public class PrefixedJsonConfigurationProvider(PrefixedJsonConfigurationSource source) : JsonConfigurationProvider(source)
{
    private PrefixedJsonConfigurationSource ConfigSource { get; } = source;
