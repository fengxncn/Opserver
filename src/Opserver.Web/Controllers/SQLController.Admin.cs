...
{
    [Route("sql/remove-plan"), HttpPost, OnlyAllow(SQLRoles.Admin)]
    ...
    [Route("sql/toggle-agent-job"), HttpPost, OnlyAllow(SQLRoles.Admin)]
    ...
    [Route("sql/start-agent-job"), HttpPost, OnlyAllow(SQLRoles.Admin)]
    ...
    [Route("sql/stop-agent-job"), HttpPost, OnlyAllow(SQLRoles.Admin)]
