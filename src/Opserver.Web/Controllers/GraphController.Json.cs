...
public partial class GraphController
{
    ...
    [ResponseCache(Duration = 120, VaryByQueryKeys = ["id", "start", "end", "summary"], Location = ResponseCacheLocation.Client)]
    ...
    [OnlyAllow(DashboardRoles.Viewer)]
    [ResponseCache(Duration = 120, VaryByQueryKeys = ["id", "iid", "start", "end", "summary"], Location = ResponseCacheLocation.Client)]
