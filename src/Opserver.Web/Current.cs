...
public static class Current
{
    ...
    public class CurrentContext(SecurityProvider security, HttpContext httpContext, IEnumerable<StatusModule> modules)
    {
        private readonly IEnumerable<StatusModule> _modules = modules;

        /// <summary>
        /// The security provider for this context.
        /// </summary>
        public SecurityProvider Security { get; } = security;
