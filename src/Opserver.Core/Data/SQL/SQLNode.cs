...
public partial class SQLNode(SQLModule module, SQLCluster sqlCluster, SQLSettings.Instance node) : SQLInstance(module, node), IEquatable<SQLNode>
{
    public override string Description => base.Description ?? Cluster?.Description;
    public SQLCluster Cluster { get; internal set; } = sqlCluster;
