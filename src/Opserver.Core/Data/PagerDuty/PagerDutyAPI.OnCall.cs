...
public partial class PagerDutyContactMethod
{
    [DataMember(Name = "id")]
    public string Id {get; set; }
        ...
        get
        {
            ...
            switch (Type)
            {
                ...
                case "phone_contact_method":
                    ...
                    {
                        case 1: // US
                            sb.Append(GetAddressRegex().Replace(Address, "($1) $2-$3"));
                            break;
                        case 61: // AU
                            sb.Append(GetAddressRegex2().Replace(Address, "$1 $2"));
                            break;
    ...
    private static partial Regex GetAddressRegex();
    [GeneratedRegex(@"(\d{4})(\d{4})")]
    private static partial Regex GetAddressRegex2();
}
