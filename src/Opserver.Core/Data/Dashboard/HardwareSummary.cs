...
{
    public List<ProcessorInfo> Processors { get; internal set; } = [];
    public List<MemoryModuleInfo> MemoryModules { get; internal set; } = [];
    public List<ComponentInfo> Components { get; internal set; } = [];
    public StorageInfo Storage { get; internal set; } = new StorageInfo();
    public List<TemperatureInfo> Temps { get; internal set; } = [];
    public List<PowerSupplyInfo> PowerSupplies { get; internal set; } = [];
    ...
    {
        public List<ControllerInfo> Controllers { get; internal set; } = [];
        public List<PhysicalDiskInfo> PhysicalDisks { get; internal set; } = [];
        public List<VirtualDiskInfo> VirtualDisks { get; internal set; } = [];
        public List<ComponentInfo> Batteries { get; internal set; } = [];
