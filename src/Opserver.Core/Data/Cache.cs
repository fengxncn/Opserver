...
public abstract class Cache(
    ...
    [CallerMemberName] string memberName = "",
    [CallerFilePath] string sourceFilePath = "",
    [CallerLineNumber] int sourceLineNumber = 0) : IMonitorStatus, IDisposable
{
    public PollNode Owner { get; private set; } = owner;
    ...
    /// </summary>
    public string ParentMemberName { get; } = memberName;
