...
public partial class Item : IMonitorStatus
{
    /// <summary>
    /// pxname: proxy name
    /// </summary>
    ...
    // TODO: Settings
    private static readonly Regex _compactReplacer = GetCompactReplacerRegex();
    ...
    private static readonly Regex _upGoingDown = GetUpGoingDownRegex();
    private static readonly Regex _downGoingUp = GetDownGoingUpRegex();
    ...
    private static partial Regex GetCompactReplacerRegex();
    [GeneratedRegex(@"UP \d+/\d+", RegexOptions.Compiled)]
    private static partial Regex GetUpGoingDownRegex();
    [GeneratedRegex(@"DOWN \d+/\d+", RegexOptions.Compiled)]
    private static partial Regex GetDownGoingUpRegex();
}
