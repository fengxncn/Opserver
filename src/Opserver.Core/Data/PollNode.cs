...
public abstract class PollNode<T>(T module, string uniqueKey) : PollNode(uniqueKey) where T : StatusModule
{
    public T Module { get; } = module;
    protected override StatusModule GetParentModule() => Module;
}

public abstract partial class PollNode(string uniqueKey) : IMonitorStatus, IDisposable, IEquatable<PollNode>
{
