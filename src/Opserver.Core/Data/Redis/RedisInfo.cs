...
public partial class RedisInfo
{
    ...
    public partial class ReplicationInfo : RedisInfoSection
    {
        ...
        public readonly List<RedisReplicaInfo> ReplicaConnections = [];
        private static readonly Regex _replicaRegex = GetReplicaRegex();
        ...
        [GeneratedRegex(@"slave\d+", RegexOptions.Compiled)]
        private static partial Regex GetReplicaRegex();
    }
    ...
    public partial class KeyspaceInfo : RedisInfoSection
    {
        public readonly Dictionary<int, KeyData> KeyData = [];

        private static readonly Regex _dbNameMatch = GetDbNameMatchRegex();
        private static readonly Regex _keysMatch = GetKeysMatchRegex();
        ...
        [GeneratedRegex("db([0-9]+)", RegexOptions.Compiled)]
        private static partial Regex GetDbNameMatchRegex();
        [GeneratedRegex("keys=([0-9]+),expires=([0-9]+)", RegexOptions.Compiled)]
        private static partial Regex GetKeysMatchRegex();
    }
}
